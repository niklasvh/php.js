...
http.createServer(function (req, res) {
    ...
    if (urlParse.path === "/thread.js" || urlParse.path === "/PHP.js" || urlParse.path.substring(0,5) === "/cfg/" || urlParse.path.substring(0,5) === "/src/" || urlParse.path.substring(0,10) === "/adapters/" || urlParse.path.substring(0,7).toLowerCase() === "/tests/") {
        res.writeHead(200, {

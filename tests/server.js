...
http.createServer(function (req, res) {
    ...
    if (urlParse.path.substring(0,5) === "/cfg/" || urlParse.path.substring(0,5) === "/src/" || urlParse.path.substring(0,10) === "/adapters/" || urlParse.path.substring(0,7).toLowerCase() === "/tests/") {
        res.writeHead(200, {
